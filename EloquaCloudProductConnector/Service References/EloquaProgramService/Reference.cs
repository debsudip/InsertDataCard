...
namespace Philips.DigitalServices.Eloqua.EloquaCloudProductConnector.EloquaProgramService
{
    ...
    public partial class Member : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private EloquaCloudProductConnector.EloquaProgramService.EntityType EntityTypeField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private int IdField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private EloquaCloudProductConnector.EloquaProgramService.ExternalActionStatus StatusField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public EloquaCloudProductConnector.EloquaProgramService.EntityType EntityType {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public EloquaCloudProductConnector.EloquaProgramService.ExternalActionStatus Status {
            get {
    ...
    public interface ExternalActionService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://secure.eloqua.com/API/1.2/ExternalActionService/ListExternalActionStepsBy" +
            ...
            "TypeResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(EloquaCloudProductConnector.EloquaProgramService.UnexpectedErrorFault), Action="https://secure.eloqua.com/API/1.2/ExternalActionService/ListExternalActionStepsBy" +
            "TypeUnexpectedErrorFaultFault", Name="UnexpectedErrorFault")]
        EloquaCloudProductConnector.EloquaProgramService.Step[] ListExternalActionStepsByType(string externalProvider);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://secure.eloqua.com/API/1.2/ExternalActionService/GetMemberCountInStepBySta" +
            ...
            "tusResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(EloquaCloudProductConnector.EloquaProgramService.UnexpectedErrorFault), Action="https://secure.eloqua.com/API/1.2/ExternalActionService/GetMemberCountInStepBySta" +
            "tusUnexpectedErrorFaultFault", Name="UnexpectedErrorFault")]
        int GetMemberCountInStepByStatus(int stepId, EloquaCloudProductConnector.EloquaProgramService.ExternalActionStatus status);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://secure.eloqua.com/API/1.2/ExternalActionService/ListMembersInStepByStatus" +
            ...
            "Response")]
        [System.ServiceModel.FaultContractAttribute(typeof(EloquaCloudProductConnector.EloquaProgramService.UnexpectedErrorFault), Action="https://secure.eloqua.com/API/1.2/ExternalActionService/ListMembersInStepByStatus" +
            "UnexpectedErrorFaultFault", Name="UnexpectedErrorFault")]
        EloquaCloudProductConnector.EloquaProgramService.Member[] ListMembersInStepByStatus(int stepId, EloquaCloudProductConnector.EloquaProgramService.ExternalActionStatus status, int pageNumber, int pageSize);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(EloquaCloudProductConnector.EloquaProgramService.UnexpectedErrorFault), Action="https://secure.eloqua.com/API/1.2/ExternalActionService/SetMemberStatusUnexpected" +
            "ErrorFaultFault", Name="UnexpectedErrorFault")]
        EloquaCloudProductConnector.EloquaProgramService.Member[] SetMemberStatus(EloquaCloudProductConnector.EloquaProgramService.Member[] members, EloquaCloudProductConnector.EloquaProgramService.ExternalActionStatus status);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ExternalActionServiceChannel : EloquaCloudProductConnector.EloquaProgramService.ExternalActionService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ExternalActionServiceClient : System.ServiceModel.ClientBase<EloquaCloudProductConnector.EloquaProgramService.ExternalActionService>, EloquaCloudProductConnector.EloquaProgramService.ExternalActionService {
        ...
        public EloquaCloudProductConnector.EloquaProgramService.Step[] ListExternalActionStepsByType(string externalProvider) {
            return base.Channel.ListExternalActionStepsByType(externalProvider);
        }
        
        public int GetMemberCountInStepByStatus(int stepId, EloquaCloudProductConnector.EloquaProgramService.ExternalActionStatus status) {
            return base.Channel.GetMemberCountInStepByStatus(stepId, status);
        }
        
        public EloquaCloudProductConnector.EloquaProgramService.Member[] ListMembersInStepByStatus(int stepId, EloquaCloudProductConnector.EloquaProgramService.ExternalActionStatus status, int pageNumber, int pageSize) {
            return base.Channel.ListMembersInStepByStatus(stepId, status, pageNumber, pageSize);
        }
        
        public EloquaCloudProductConnector.EloquaProgramService.Member[] SetMemberStatus(EloquaCloudProductConnector.EloquaProgramService.Member[] members, EloquaCloudProductConnector.EloquaProgramService.ExternalActionStatus status) {
